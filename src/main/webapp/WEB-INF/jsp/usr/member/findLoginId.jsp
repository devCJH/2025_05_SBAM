	...
	<section class="mt-8">
		<div class="container mx-auto">
			...
			<div class="p-6 flex justify-between">
				...
				<div class="flex">
					<div class="mr-2"><a class="btn btn-neutral btn-outline btn-xs" href="findLoginPw">비밀번호 찾기</a></div>
					<div><a class="btn btn-neutral btn-outline btn-xs" href="login">로그인</a></div>
				</div>
			</div>
		</div>
	</section>
